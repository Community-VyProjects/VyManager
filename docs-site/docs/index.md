...
- [Reference](reference/authentication) — auth, errors, API conventions, commit-confirm, and the [API reference](/api/)
- [Operations](operations/backups) — backups, upgrades, reverse proxy, troubleshooting
- [Contributing](contributing/dev-setup) — dev setup, tests, API reference
