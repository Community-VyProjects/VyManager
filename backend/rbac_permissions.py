...
BUILT_IN_PERMISSIONS: Dict[str, Dict[FeatureGroup, PermissionLevel]] = {
    BuiltInRole.ADMIN: {
        ...
        FeatureGroup.EVENT_HANDLER: PermissionLevel.WRITE,
        ...
        FeatureGroup.NDP_PROXY: PermissionLevel.WRITE,
        FeatureGroup.NTP: PermissionLevel.WRITE,
        FeatureGroup.ROUTER_ADVERT: PermissionLevel.WRITE,
        FeatureGroup.SALT_MINION: PermissionLevel.WRITE,
    ...
    BuiltInRole.VIEWER: {
        ...
        FeatureGroup.EVENT_HANDLER: PermissionLevel.READ,
        ...
        FeatureGroup.NDP_PROXY: PermissionLevel.READ,
        FeatureGroup.NTP: PermissionLevel.READ,
        FeatureGroup.ROUTER_ADVERT: PermissionLevel.READ,
        FeatureGroup.SALT_MINION: PermissionLevel.READ,
