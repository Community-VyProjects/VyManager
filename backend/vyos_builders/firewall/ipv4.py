...
class FirewallIPv4BatchBuilder:
    ...
    def set_custom_chain_default_log(self, chain_name: str) -> "FirewallIPv4BatchBuilder":
        """Enable default logging for a custom chain."""
        path = self.mappers[self.mapper_key].get_custom_chain_default_log(chain_name)
        return self.add_set(path)

    def delete_custom_chain_default_log(self, chain_name: str) -> "FirewallIPv4BatchBuilder":
        """Delete default logging for a custom chain."""
        path = self.mappers[self.mapper_key].get_custom_chain_default_log_path(chain_name)
        return self.add_delete(path)

    def set_custom_chain_default_jump_target(self, chain_name: str, target: str) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_custom_chain_default_jump_target(self, chain_name: str) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_connection_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set connection mark match."""
        path = self.mappers[self.mapper_key].get_rule_connection_mark(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_connection_mark(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_connection_status_nat(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_connection_status_nat(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_conntrack_helper(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set conntrack helper."""
        path = self.mappers[self.mapper_key].get_rule_conntrack_helper(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_conntrack_helper(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_dscp(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set DSCP match value."""
        path = self.mappers[self.mapper_key].get_rule_dscp(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_dscp(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_dscp_exclude(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set DSCP exclude value."""
        path = self.mappers[self.mapper_key].get_rule_dscp_exclude(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_dscp_exclude(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_fragment_match_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Enable fragment match."""
        path = self.mappers[self.mapper_key].get_rule_fragment_match_frag(chain, rule_number, is_custom)
        return self.add_set(path)

    def delete_rule_fragment_match_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete fragment match."""
        path = self.mappers[self.mapper_key].get_rule_fragment_match_frag_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_fragment_match_non_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Enable non-fragment match."""
        path = self.mappers[self.mapper_key].get_rule_fragment_match_non_frag(chain, rule_number, is_custom)
        return self.add_set(path)

    def delete_rule_fragment_match_non_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_fragment(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_icmp_code(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set ICMP code."""
        path = self.mappers[self.mapper_key].get_rule_icmp_code(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_icmp_code(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete ICMP code."""
        path = self.mappers[self.mapper_key].get_rule_icmp_code_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_icmp_type(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set ICMP type."""
        path = self.mappers[self.mapper_key].get_rule_icmp_type(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_icmp_type(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete ICMP type."""
    ...
    def set_rule_inbound_interface_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_inbound_interface_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_outbound_interface_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_outbound_interface_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ipsec_match_ipsec(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Enable IPsec match."""
        path = self.mappers[self.mapper_key].get_rule_ipsec_match_ipsec(chain, rule_number, is_custom)
        return self.add_set(path)

    def delete_rule_ipsec_match_ipsec(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete IPsec match."""
        path = self.mappers[self.mapper_key].get_rule_ipsec_match_ipsec_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_ipsec_match_none(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Enable IPsec none match."""
        path = self.mappers[self.mapper_key].get_rule_ipsec_match_none(chain, rule_number, is_custom)
        return self.add_set(path)

    def delete_rule_ipsec_match_none(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete IPsec none match."""
        path = self.mappers[self.mapper_key].get_rule_ipsec_match_none_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def delete_rule_ipsec(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ipsec_match_ipsec_in(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_ipsec_match_ipsec_in(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ipsec_match_ipsec_out(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_ipsec_match_ipsec_out(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ipsec_match_none_in(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_ipsec_match_none_in(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ipsec_match_none_out(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_ipsec_match_none_out(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_limit_rate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set rate limit."""
        path = self.mappers[self.mapper_key].get_rule_limit_rate(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_limit_rate(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete rate limit."""
        path = self.mappers[self.mapper_key].get_rule_limit_rate_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_limit_burst(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set limit burst."""
        path = self.mappers[self.mapper_key].get_rule_limit_burst(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_limit_burst(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete limit burst."""
        path = self.mappers[self.mapper_key].get_rule_limit_burst_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def delete_rule_limit(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_log_options_group(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set log options group."""
        path = self.mappers[self.mapper_key].get_rule_log_options_group(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_log_options_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete log options group."""
        path = self.mappers[self.mapper_key].get_rule_log_options_group_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_log_options_level(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set log options level."""
        path = self.mappers[self.mapper_key].get_rule_log_options_level(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_log_options_level(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete log options level."""
        path = self.mappers[self.mapper_key].get_rule_log_options_level_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_log_options_queue_threshold(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_log_options_queue_threshold(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_log_options_snapshot_length(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_log_options_snapshot_length(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_log_options(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set mark match value."""
        path = self.mappers[self.mapper_key].get_rule_mark(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_mark(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_packet_length(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set packet length match."""
        path = self.mappers[self.mapper_key].get_rule_packet_length(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_packet_length(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_packet_length_exclude(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_packet_length_exclude(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_packet_type(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set packet type match."""
        path = self.mappers[self.mapper_key].get_rule_packet_type(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_packet_type(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_queue(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set queue number."""
        path = self.mappers[self.mapper_key].get_rule_queue(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_queue(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete queue number."""
    ...
    def set_rule_queue_options(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set queue options."""
        path = self.mappers[self.mapper_key].get_rule_queue_options(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_queue_options(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_recent_count(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set recent count."""
        path = self.mappers[self.mapper_key].get_rule_recent_count(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_recent_count(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete recent count."""
        path = self.mappers[self.mapper_key].get_rule_recent_count_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_recent_time(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set recent time."""
        path = self.mappers[self.mapper_key].get_rule_recent_time(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_recent_time(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete recent time."""
        path = self.mappers[self.mapper_key].get_rule_recent_time_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def delete_rule_recent(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_source_fqdn(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set source FQDN."""
        path = self.mappers[self.mapper_key].get_rule_source_fqdn(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_source_fqdn(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete source FQDN."""
        path = self.mappers[self.mapper_key].get_rule_source_fqdn_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_source_address_mask(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set source address mask."""
        path = self.mappers[self.mapper_key].get_rule_source_address_mask(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_source_address_mask(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_destination_fqdn(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set destination FQDN."""
        path = self.mappers[self.mapper_key].get_rule_destination_fqdn(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_destination_fqdn(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete destination FQDN."""
        path = self.mappers[self.mapper_key].get_rule_destination_fqdn_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_destination_address_mask(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_destination_address_mask(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_destination_mac_address(self, chain: str, rule_number: int, mac: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set destination MAC address."""
        path = self.mappers[self.mapper_key].get_rule_destination_mac_address(chain, rule_number, mac, is_custom)
        return self.add_set(path)

    def delete_rule_destination_mac_address(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_source_group_dynamic_address(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_source_group_dynamic_address(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_destination_group_dynamic_address(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_destination_group_dynamic_address(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_synproxy_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set synproxy TCP MSS."""
        path = self.mappers[self.mapper_key].get_rule_synproxy_tcp_mss(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_synproxy_tcp_mss(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete synproxy TCP MSS."""
        path = self.mappers[self.mapper_key].get_rule_synproxy_tcp_mss_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_synproxy_tcp_window_scale(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_synproxy_tcp_window_scale(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_synproxy(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set TCP MSS match value."""
        path = self.mappers[self.mapper_key].get_rule_tcp_mss(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_tcp_mss(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_time_startdate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set time start date."""
        path = self.mappers[self.mapper_key].get_rule_time_startdate(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_time_startdate(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete time start date."""
        path = self.mappers[self.mapper_key].get_rule_time_startdate_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_time_starttime(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set time start time."""
        path = self.mappers[self.mapper_key].get_rule_time_starttime(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_time_starttime(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete time start time."""
        path = self.mappers[self.mapper_key].get_rule_time_starttime_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_time_stopdate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set time stop date."""
        path = self.mappers[self.mapper_key].get_rule_time_stopdate(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_time_stopdate(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete time stop date."""
        path = self.mappers[self.mapper_key].get_rule_time_stopdate_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_time_stoptime(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set time stop time."""
        path = self.mappers[self.mapper_key].get_rule_time_stoptime(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_time_stoptime(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete time stop time."""
        path = self.mappers[self.mapper_key].get_rule_time_stoptime_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_time_weekdays(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set time weekdays."""
        path = self.mappers[self.mapper_key].get_rule_time_weekdays(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_time_weekdays(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete time weekdays."""
        path = self.mappers[self.mapper_key].get_rule_time_weekdays_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def delete_rule_time(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_ttl_eq(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set TTL equal match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_eq(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_ttl_eq(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete TTL equal match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_eq_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_ttl_gt(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set TTL greater-than match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_gt(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_ttl_gt(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete TTL greater-than match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_gt_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_ttl_lt(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set TTL less-than match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_lt(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_ttl_lt(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete TTL less-than match."""
        path = self.mappers[self.mapper_key].get_rule_ttl_lt_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def delete_rule_ttl(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_add_address_to_group_src_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_src_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_add_address_to_group_src_timeout(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_src_timeout(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_src(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_add_address_to_group_dst_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_dst_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_add_address_to_group_dst_timeout(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_dst_timeout(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group_dst(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_add_address_to_group(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_set_connection_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_set_connection_mark(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_set_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set TCP MSS (packet modification)."""
        path = self.mappers[self.mapper_key].get_rule_set_tcp_mss(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_set_tcp_mss(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_set(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_key(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set GRE key (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_rule_gre_key(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_gre_key(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete GRE key (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_rule_gre_key_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_gre_version(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Set GRE version (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_rule_gre_version(chain, rule_number, value, is_custom)
        return self.add_set(path)

    def delete_rule_gre_version(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Delete GRE version (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_rule_gre_version_path(chain, rule_number, is_custom)
        return self.add_delete(path)

    def set_rule_gre_inner_proto(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_inner_proto(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_checksum(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_flags_checksum(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_checksum_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_flags_checksum_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_key(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
        """Enable GRE key flag (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_rule_gre_flags_key(chain, rule_number, is_custom)
        return self.add_set(path)

    def delete_rule_gre_flags_key(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_key_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_flags_key_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_sequence(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_flags_sequence(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_rule_gre_flags_sequence_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre_flags_sequence_unset(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_rule_gre(self, chain: str, rule_number: int, is_custom: bool = False) -> "FirewallIPv4BatchBuilder":
    ...
    def set_prerouting_raw_rule(self, rule_number: int) -> "FirewallIPv4BatchBuilder":
        """Create a prerouting raw rule (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_prerouting_raw_rule(rule_number)
        return self.add_set(path)

    def delete_prerouting_raw_rule(self, rule_number: int) -> "FirewallIPv4BatchBuilder":
        """Delete a prerouting raw rule (VyOS 1.5+ only)."""
        path = self.mappers[self.mapper_key].get_prerouting_raw_rule_path(rule_number)
        return self.add_delete(path)

    def set_prerouting_raw_default_action(self, action: str) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_prerouting_raw_default_action(self) -> "FirewallIPv4BatchBuilder":
    ...
    def delete_prerouting_raw_default_jump_target(self) -> "FirewallIPv4BatchBuilder":
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "features": {
                ...
                "prerouting_raw": {
                    "supported": is_v15,
                    "description": "Prerouting raw chain (VyOS 1.5+ only)",
                },
                "gre_matching": {
                    "supported": is_v15,
