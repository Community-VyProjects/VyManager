...
class FirewallIPv4Mapper(BaseFeatureMapper):
    ...
    def get_custom_chain_default_log(self, chain_name: str) -> List[str]:
        ...
        return ["firewall", "ipv4", "name", chain_name, "default-log"]
    ...
    def get_custom_chain_default_jump_target(self, chain_name: str, target: str) -> List[str]:
        ...
        return ["firewall", "ipv4", "name", chain_name, "default-jump-target", target]
    ...
    def get_custom_chain_default_jump_target_path(self, chain_name: str) -> List[str]:
        ...
        return ["firewall", "ipv4", "name", chain_name, "default-jump-target"]
    ...
    def get_rule_connection_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "connection-mark", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "connection-mark", value]
    ...
    def get_rule_connection_mark_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "connection-mark"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "connection-mark"]
    ...
    def get_rule_connection_status_nat(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "connection-status", "nat", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "connection-status", "nat", value]
    ...
    def get_rule_connection_status_nat_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "connection-status", "nat"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "connection-status", "nat"]
    ...
    def get_rule_conntrack_helper(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "conntrack-helper", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "conntrack-helper", value]
    ...
    def get_rule_conntrack_helper_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "conntrack-helper"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "conntrack-helper"]
    ...
    def get_rule_dscp(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "dscp", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "dscp", value]
    ...
    def get_rule_dscp_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "dscp"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "dscp"]
    ...
    def get_rule_dscp_exclude(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "dscp-exclude", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "dscp-exclude", value]
    ...
    def get_rule_dscp_exclude_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "dscp-exclude"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "dscp-exclude"]
    ...
    def get_rule_fragment_match_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "fragment", "match-frag"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "fragment", "match-frag"]
    ...
    def get_rule_fragment_match_non_frag(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "fragment", "match-non-frag"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "fragment", "match-non-frag"]
    ...
    def get_rule_fragment_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "fragment"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "fragment"]
    ...
    def get_rule_icmp_code(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "icmp", "code", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "icmp", "code", value]
    ...
    def get_rule_icmp_code_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "icmp", "code"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "icmp", "code"]
    ...
    def get_rule_icmp_type(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "icmp", "type", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "icmp", "type", value]
    ...
    def get_rule_icmp_type_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "icmp", "type"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "icmp", "type"]
    ...
    def get_rule_inbound_interface_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "inbound-interface", "group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "inbound-interface", "group", group_name]
    ...
    def get_rule_inbound_interface_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "inbound-interface", "group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "inbound-interface", "group"]
    ...
    def get_rule_outbound_interface_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "outbound-interface", "group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "outbound-interface", "group", group_name]
    ...
    def get_rule_outbound_interface_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "outbound-interface", "group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "outbound-interface", "group"]
    ...
    def get_rule_limit_rate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "limit", "rate", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "limit", "rate", value]
    ...
    def get_rule_limit_rate_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "limit", "rate"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "limit", "rate"]
    ...
    def get_rule_limit_burst(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "limit", "burst", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "limit", "burst", value]
    ...
    def get_rule_limit_burst_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "limit", "burst"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "limit", "burst"]
    ...
    def get_rule_limit_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "limit"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "limit"]
    ...
    def get_rule_log_options_group(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "group", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "group", value]
    ...
    def get_rule_log_options_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "group"]
    ...
    def get_rule_log_options_level(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "level", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "level", value]
    ...
    def get_rule_log_options_level_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "level"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "level"]
    ...
    def get_rule_log_options_queue_threshold(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "queue-threshold", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "queue-threshold", value]
    ...
    def get_rule_log_options_queue_threshold_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "queue-threshold"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "queue-threshold"]
    ...
    def get_rule_log_options_snapshot_length(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "snapshot-length", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "snapshot-length", value]
    ...
    def get_rule_log_options_snapshot_length_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options", "snapshot-length"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options", "snapshot-length"]
    ...
    def get_rule_log_options_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "log-options"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "log-options"]
    ...
    def get_rule_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "mark", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "mark", value]
    ...
    def get_rule_mark_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "mark"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "mark"]
    ...
    def get_rule_packet_length(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-length", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-length", value]
    ...
    def get_rule_packet_length_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-length"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-length"]
    ...
    def get_rule_packet_length_exclude(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-length-exclude", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-length-exclude", value]
    ...
    def get_rule_packet_length_exclude_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-length-exclude"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-length-exclude"]
    ...
    def get_rule_packet_type(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-type", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-type", value]
    ...
    def get_rule_packet_type_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "packet-type"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "packet-type"]
    ...
    def get_rule_queue(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "queue", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "queue", value]
    ...
    def get_rule_queue_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "queue"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "queue"]
    ...
    def get_rule_queue_options(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "queue-options", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "queue-options", value]
    ...
    def get_rule_queue_options_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "queue-options"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "queue-options"]
    ...
    def get_rule_recent_count(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "recent", "count", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "recent", "count", value]
    ...
    def get_rule_recent_count_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "recent", "count"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "recent", "count"]
    ...
    def get_rule_recent_time(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "recent", "time", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "recent", "time", value]
    ...
    def get_rule_recent_time_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "recent", "time"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "recent", "time"]
    ...
    def get_rule_recent_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "recent"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "recent"]
    ...
    def get_rule_source_fqdn(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "fqdn", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "fqdn", value]
    ...
    def get_rule_source_fqdn_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "fqdn"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "fqdn"]
    ...
    def get_rule_source_address_mask(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "address-mask", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "address-mask", value]
    ...
    def get_rule_source_address_mask_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "address-mask"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "address-mask"]
    ...
    def get_rule_destination_fqdn(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "fqdn", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "fqdn", value]
    ...
    def get_rule_destination_fqdn_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "fqdn"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "fqdn"]
    ...
    def get_rule_destination_address_mask(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "address-mask", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "address-mask", value]
    ...
    def get_rule_destination_address_mask_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "address-mask"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "address-mask"]
    ...
    def get_rule_destination_mac_address(self, chain: str, rule_number: int, mac: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "mac-address", mac]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "mac-address", mac]
    ...
    def get_rule_destination_mac_address_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "mac-address"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "mac-address"]
    ...
    def get_rule_source_group_dynamic_address(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "group", "dynamic-address-group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "group", "dynamic-address-group", group_name]
    ...
    def get_rule_source_group_dynamic_address_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "source", "group", "dynamic-address-group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "source", "group", "dynamic-address-group"]
    ...
    def get_rule_destination_group_dynamic_address(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "group", "dynamic-address-group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "group", "dynamic-address-group", group_name]
    ...
    def get_rule_destination_group_dynamic_address_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "destination", "group", "dynamic-address-group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "destination", "group", "dynamic-address-group"]
    ...
    def get_rule_synproxy_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "synproxy", "tcp", "mss", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "synproxy", "tcp", "mss", value]
    ...
    def get_rule_synproxy_tcp_mss_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "synproxy", "tcp", "mss"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "synproxy", "tcp", "mss"]
    ...
    def get_rule_synproxy_tcp_window_scale(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "synproxy", "tcp", "window-scale", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "synproxy", "tcp", "window-scale", value]
    ...
    def get_rule_synproxy_tcp_window_scale_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "synproxy", "tcp", "window-scale"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "synproxy", "tcp", "window-scale"]
    ...
    def get_rule_synproxy_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "synproxy"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "synproxy"]
    ...
    def get_rule_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "tcp", "mss", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "tcp", "mss", value]
    ...
    def get_rule_tcp_mss_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "tcp", "mss"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "tcp", "mss"]
    ...
    def get_rule_time_startdate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "startdate", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "startdate", value]
    ...
    def get_rule_time_startdate_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "startdate"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "startdate"]
    ...
    def get_rule_time_starttime(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "starttime", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "starttime", value]
    ...
    def get_rule_time_starttime_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "starttime"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "starttime"]
    ...
    def get_rule_time_stopdate(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "stopdate", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "stopdate", value]
    ...
    def get_rule_time_stopdate_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "stopdate"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "stopdate"]
    ...
    def get_rule_time_stoptime(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "stoptime", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "stoptime", value]
    ...
    def get_rule_time_stoptime_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "stoptime"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "stoptime"]
    ...
    def get_rule_time_weekdays(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "weekdays", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "weekdays", value]
    ...
    def get_rule_time_weekdays_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time", "weekdays"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time", "weekdays"]
    ...
    def get_rule_time_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "time"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "time"]
    ...
    def get_rule_ttl_eq(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "eq", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "eq", value]
    ...
    def get_rule_ttl_eq_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "eq"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "eq"]
    ...
    def get_rule_ttl_gt(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "gt", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "gt", value]
    ...
    def get_rule_ttl_gt_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "gt"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "gt"]
    ...
    def get_rule_ttl_lt(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "lt", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "lt", value]
    ...
    def get_rule_ttl_lt_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl", "lt"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl", "lt"]
    ...
    def get_rule_ttl_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "ttl"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "ttl"]
    ...
    def get_rule_add_address_to_group_src_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "source-address", "address-group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "source-address", "address-group", group_name]
    ...
    def get_rule_add_address_to_group_src_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "source-address", "address-group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "source-address", "address-group"]
    ...
    def get_rule_add_address_to_group_src_timeout(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "source-address", "timeout", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "source-address", "timeout", value]
    ...
    def get_rule_add_address_to_group_src_timeout_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "source-address", "timeout"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "source-address", "timeout"]
    ...
    def get_rule_add_address_to_group_src_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "source-address"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "source-address"]
    ...
    def get_rule_add_address_to_group_dst_group(self, chain: str, rule_number: int, group_name: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "destination-address", "address-group", group_name]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "destination-address", "address-group", group_name]
    ...
    def get_rule_add_address_to_group_dst_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "destination-address", "address-group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "destination-address", "address-group"]
    ...
    def get_rule_add_address_to_group_dst_timeout(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "destination-address", "timeout", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "destination-address", "timeout", value]
    ...
    def get_rule_add_address_to_group_dst_timeout_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "destination-address", "timeout"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "destination-address", "timeout"]
    ...
    def get_rule_add_address_to_group_dst_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group", "destination-address"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group", "destination-address"]
    ...
    def get_rule_add_address_to_group_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "add-address-to-group"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "add-address-to-group"]
    ...
    def get_rule_set_connection_mark(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "set", "connection-mark", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "set", "connection-mark", value]
    ...
    def get_rule_set_connection_mark_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "set", "connection-mark"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "set", "connection-mark"]
    ...
    def get_rule_set_tcp_mss(self, chain: str, rule_number: int, value: str, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "set", "tcp-mss", value]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "set", "tcp-mss", value]
    ...
    def get_rule_set_tcp_mss_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "set", "tcp-mss"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "set", "tcp-mss"]
    ...
    def get_rule_set_path(self, chain: str, rule_number: int, is_custom: bool = False) -> List[str]:
        ...
        if is_custom:
            return ["firewall", "ipv4", "name", chain, "rule", str(rule_number), "set"]
        return ["firewall", "ipv4", chain, "filter", "rule", str(rule_number), "set"]
