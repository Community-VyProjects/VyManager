...
Handles bridge interface commands.
...
class BridgeInterfaceMapper(BaseFeatureMapper):
    """Base bridge interface mapper with common operations for all versions."""
    ...
    def get_aging(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["aging", value]

    def get_aging_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["aging"]

    def get_forwarding_delay(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["forwarding-delay", value]

    def get_forwarding_delay_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["forwarding-delay"]

    def get_hello_time(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["hello-time", value]

    def get_hello_time_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["hello-time"]

    def get_max_age(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["max-age", value]

    def get_max_age_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["max-age"]

    def get_priority(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["priority", value]

    def get_priority_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["priority"]

    def get_stp(self, interface: str) -> List[str]:
        return self._base(interface) + ["stp"]

    def get_enable_vlan(self, interface: str) -> List[str]:
        return self._base(interface) + ["enable-vlan"]

    def get_protocol(self, interface: str, value: str) -> List[str]:
        return self._base(interface) + ["protocol", value]
    ...
    def get_igmp_snooping(self, interface: str) -> List[str]:
        return self._base(interface) + ["igmp", "snooping"]

    def get_igmp_querier(self, interface: str) -> List[str]:
        return self._base(interface) + ["igmp", "querier"]

    def get_igmp_path(self, interface: str) -> List[str]:
        return self._base(interface) + ["igmp"]
    ...
    def get_member_interface_cost(self, interface: str, member: str, cost: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "cost", cost]

    def get_member_interface_cost_path(self, interface: str, member: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "cost"]

    def get_member_interface_priority(self, interface: str, member: str, priority: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "priority", priority]

    def get_member_interface_priority_path(self, interface: str, member: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "priority"]

    def get_member_interface_isolated(self, interface: str, member: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "isolated"]

    def get_member_interface_native_vlan(self, interface: str, member: str, vlan: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "native-vlan", vlan]

    def get_member_interface_native_vlan_path(self, interface: str, member: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "native-vlan"]

    def get_member_interface_allowed_vlan(self, interface: str, member: str, vlan: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "allowed-vlan", vlan]

    def get_member_interface_allowed_vlan_path(self, interface: str, member: str) -> List[str]:
        return self._base(interface) + ["member", "interface", member, "allowed-vlan"]
    ...
    def _parse_members(self, config: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if not isinstance(iface_config, dict):
            return members
        for member_name, member_data in iface_config.items():
            entry = {"name": member_name}
            if isinstance(member_data, dict):
                entry["cost"] = member_data.get("cost")
                entry["priority"] = member_data.get("priority")
                entry["isolated"] = "isolated" in member_data
                entry["native_vlan"] = member_data.get("native-vlan")
                allowed = member_data.get("allowed-vlan")
                if isinstance(allowed, list):
                    entry["allowed_vlan"] = allowed
                ...
                entry["native_vlan"] = None
                entry["allowed_vlan"] = []
            members.append(entry)
        return members

    def _parse_igmp(self, config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        igmp = config.get("igmp")
        if not igmp or not isinstance(igmp, dict):
            return None
        return {
            "snooping": "snooping" in igmp,
            "querier": "querier" in igmp,
        }
    ...
    def parse_single_interface(self, name: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            ...
            "forwarding_delay": config.get("forwarding-delay"),
