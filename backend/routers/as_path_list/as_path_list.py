...
async def get_as_path_list_capabilities():
    """
...
async def get_as_path_list_config(refresh: bool = False):
    """
...
@router.post("/batch")
async def as_path_list_batch_configure(request: AsPathListBatchRequest):
    """
