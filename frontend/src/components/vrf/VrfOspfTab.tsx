  ...
  if (!ospf || !ospf.configured) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <h3 className="text-lg font-semibold mb-2">OSPF Not Configured</h3>
        <p className="text-sm text-muted-foreground text-center max-w-md">
          OSPF is not configured in VRF {vrf.name}. Configure it via the VyOS CLI
          or use the batch API to add OSPF settings.
        </p>
      </div>
    );
  }
