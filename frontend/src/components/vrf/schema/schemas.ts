...
export const ISIS_SCHEMA: SectionSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["downstream", "level-1"], label: "Tiebreaker downstream L1 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "downstream"] },
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["downstream", "level-2"], label: "Tiebreaker downstream L2 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "downstream"] },
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["lowest-backup-metric", "level-1"], label: "Tiebreaker lowest-backup-metric L1 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "lowest-backup-metric"] },
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["lowest-backup-metric", "level-2"], label: "Tiebreaker lowest-backup-metric L2 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "lowest-backup-metric"] },
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["node-protecting", "level-1"], label: "Tiebreaker node-protecting L1 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "node-protecting"] },
      { op: "vrf_isis_fr_lfa_local_tiebreaker_type_level_index", args: ["node-protecting", "level-2"], label: "Tiebreaker node-protecting L2 index", type: "text", path: ["fast-reroute", "lfa", "local", "tiebreaker", "node-protecting"] },
      { op: "vrf_isis_fr_lfa_level_remote_prefix_list", args: ["level-1"], label: "Remote prefix-list L1", type: "text", path: ["fast-reroute", "lfa", "remote", "prefix-list"] },
      { op: "vrf_isis_fr_lfa_level_remote_prefix_list", args: ["level-2"], label: "Remote prefix-list L2", type: "text", path: ["fast-reroute", "lfa", "remote", "prefix-list"] },
    ],
  },
];
