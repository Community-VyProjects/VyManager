...
interface EditCommunityListRuleModalProps {
  open: boolean;
...
export function EditCommunityListRuleModal({
  open,
  onOpenChange,
  onSuccess,
  communityListName,
  ...
  const handleSubmit = async () => {
    ...
    try {
      await communityListService.updateRule(communityListName, rule.rule_number, {
