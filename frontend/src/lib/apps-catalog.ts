...
export const APP_CATALOG: AppDef[] = [
  ...
  },
  {
    id: "netbird-cloud",
    name: "NetBird (Cloud)",
    tagline: "Zero-config WireGuard mesh VPN — managed by NetBird Cloud",
    description:
      "Join this router to your NetBird Cloud mesh as a WireGuard peer. Paste a setup key and NetBird runs the control plane for you — nothing to host.",
    category: "VPN",
    tags: ["vpn", "wireguard", "mesh", "netbird", "zero-trust", "overlay"],
    dockerImage: "netbirdio/netbird:latest",
    defaultContainerName: "netbird",
    iconPath: "/app-icons/netbird.svg",
    installConfig: {
      fields: [
        {
          name: "setupKey",
          ...
          description:
            "Generate one in the NetBird dashboard under Setup Keys. Required for the agent to register unattended.",
          required: true,
        },
        {
          name: "hostname",
          label: "Peer Name",
          type: "text",
          default: "vyos-netbird",
          placeholder: "vyos-netbird",
          description: "Name this peer shows up as in your NetBird network.",
          required: true,
        },
      ],
      network: {
      ...
      description: "NetBird agent — joins this router to your NetBird Cloud network",
      restart: "always",
      hostname: "${hostname}",
      capabilities: ["net-admin", "net-raw", "sys-admin"],
      devices: [
        { name: "tun", source: "/dev/net/tun", destination: "/dev/net/tun" },
      ],
      volumes: [{ name: "netbird-client", destination: "/var/lib/netbird" }],
      environment: [{ name: "NB_SETUP_KEY", value: "${setupKey}" }],
      labels: [{ name: "com.vymanager.app", value: "netbird-cloud" }],
    },
  },
  {
    id: "netbird-selfhosted",
    name: "NetBird (Self-hosted)",
    tagline: "WireGuard mesh VPN against your own NetBird control plane",
    description:
      "Join this router to a NetBird mesh as a WireGuard peer, pointed at a NetBird server you host yourself. Add your management URL and a setup key.",
    category: "VPN",
    tags: ["vpn", "wireguard", "mesh", "netbird", "zero-trust", "self-hosted", "overlay"],
    dockerImage: "netbirdio/netbird:latest",
    defaultContainerName: "netbird",
    iconPath: "/app-icons/netbird.svg",
    installConfig: {
      fields: [
        {
          ...
          description:
            "URL of your self-hosted NetBird Management server (include the scheme and port).",
          required: true,
        },
        {
          name: "setupKey",
          ...
          placeholder: "XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX",
          description:
            "Generate one in your self-hosted NetBird dashboard under Setup Keys. Required for the agent to register unattended.",
          required: true,
        },
        {
          name: "hostname",
      ...
      description: "NetBird agent — joins this router to your self-hosted NetBird network",
      restart: "always",
      hostname: "${hostname}",
      capabilities: ["net-admin", "net-raw", "sys-admin"],
      devices: [
      ...
      volumes: [{ name: "netbird-client", destination: "/var/lib/netbird" }],
      environment: [
        { name: "NB_SETUP_KEY", value: "${setupKey}" },
        { name: "NB_MANAGEMENT_URL", value: "${managementUrl}" },
      ],
      labels: [{ name: "com.vymanager.app", value: "netbird-selfhosted" }],
    },
  },
  {
    id: "tailscale-cloud",
    name: "Tailscale (Cloud)",
    tagline: "Zero-config WireGuard mesh VPN — managed by Tailscale",
    description:
      "Join this router to your Tailscale tailnet as a WireGuard peer. Paste an auth key and Tailscale runs the control plane for you — nothing to host.",
    category: "VPN",
    tags: ["vpn", "wireguard", "mesh", "tailscale", "zero-trust", "overlay", "subnet-router"],
    dockerImage: "tailscale/tailscale:latest",
    defaultContainerName: "tailscale",
    iconPath: "/app-icons/tailscale-light.svg",
    installConfig: {
      fields: [
        {
          name: "authKey",
          ...
          type: "text",
          default: "",
          placeholder: "tskey-auth-XXXXXXXXXX-XXXXXXXXXXXXXXXX",
          description:
            "Generate one in the Tailscale admin console under Settings → Keys. Required for the node to register unattended.",
          required: true,
        },
        {
          name: "hostname",
          label: "Machine Name",
          type: "text",
          default: "vyos-tailscale",
          placeholder: "vyos-tailscale",
          description: "Name this machine shows up as in your tailnet.",
          required: true,
        },
        {
          ...
          description:
            "Optional. Comma-separated subnets this router advertises to the tailnet (subnet router). Leave blank for none. Routes still need approval in the admin console.",
          required: false,
        },
      ],
      network: {
      ...
      description: "Tailscale agent — joins this router to your Tailscale tailnet",
      restart: "always",
      capabilities: ["net-admin", "net-raw"],
      devices: [
        { name: "tun", source: "/dev/net/tun", destination: "/dev/net/tun" },
      ],
      volumes: [{ name: "tailscale-state", destination: "/var/lib/tailscale" }],
      environment: [
        { name: "TS_AUTHKEY", value: "${authKey}" },
        { name: "TS_HOSTNAME", value: "${hostname}" },
        { name: "TS_ROUTES", value: "${advertiseRoutes}" },
        { name: "TS_STATE_DIR", value: "/var/lib/tailscale" },
        { name: "TS_USERSPACE", value: "false" },
      ],
      labels: [{ name: "com.vymanager.app", value: "tailscale-cloud" }],
    },
  },
  {
    id: "tailscale-headscale",
    name: "Tailscale (Headscale)",
    tagline: "Tailscale client pointed at a self-hosted Headscale server",
    description:
      "Join this router to a Headscale-managed mesh as a WireGuard peer. Same Tailscale client, pointed at a Headscale server you host yourself via a login-server URL.",
    category: "VPN",
    tags: ["vpn", "wireguard", "mesh", "tailscale", "headscale", "self-hosted", "overlay", "subnet-router"],
    dockerImage: "tailscale/tailscale:latest",
    defaultContainerName: "tailscale",
    iconPath: "/app-icons/tailscale-light.svg",
    installConfig: {
      fields: [
        {
          ...
          description:
            "URL of your self-hosted Headscale server (include the scheme).",
          required: true,
        },
        {
          name: "authKey",
          ...
          type: "text",
          default: "",
          placeholder: "generated by: headscale preauthkeys create",
          description:
            "A Headscale pre-auth key (headscale preauthkeys create --user <user>). Required for the node to register unattended.",
          required: true,
        },
        {
          name: "hostname",
          ...
          default: "vyos-tailscale",
          placeholder: "vyos-tailscale",
          description: "Name this machine shows up as in your Headscale network.",
          required: true,
        },
        {
          name: "advertiseRoutes",
          ...
          placeholder: "192.168.1.0/24,10.0.0.0/24",
          description:
            "Optional. Comma-separated subnets this router advertises (subnet router). Leave blank for none. Routes still need approval in Headscale.",
          required: false,
        },
      ],
      network: {
      ...
      description: "Tailscale agent — joins this router to your self-hosted Headscale network",
      restart: "always",
      capabilities: ["net-admin", "net-raw"],
      devices: [
        { name: "tun", source: "/dev/net/tun", destination: "/dev/net/tun" },
      ...
      environment: [
        ...
        { name: "TS_STATE_DIR", value: "/var/lib/tailscale" },
        { name: "TS_USERSPACE", value: "false" },
        { name: "TS_EXTRA_ARGS", value: "--login-server=${loginServer}" },
      ],
