  ...
  },
  {
    ...
    children: [
      ...
      { title: "DHCP", href: "/network/dhcp", requiredPermission: FeatureGroup.DHCP, sections: [
          ...
          { id: "ranges", title: "Ranges", href: "/network/dhcp", description: "Manage DHCP ranges", searchParams: { section: "ranges" } },
          { id: "static", title: "Static Mappings", href: "/network/dhcp", description: "Manage DHCP static mappings", searchParams: { section: "static" } },
          { id: "leases", title: "Leases", href: "/network/dhcp", description: "View DHCP leases", searchParams: { section: "leases" } },
        ] },
    ],
  },
  {
